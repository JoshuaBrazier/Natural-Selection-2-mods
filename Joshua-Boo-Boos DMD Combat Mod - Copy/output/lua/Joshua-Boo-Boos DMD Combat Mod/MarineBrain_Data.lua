...
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.MedPack,		10 - (1.5 + (0.5 * random) )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons1,	10 - (1.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons2,	10 - (1.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons3,	10 - (1.0 + random )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor1,		10 - (1.75 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor2,		10 - (1.75 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor3,      10 - (1.75 + random )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Scan,        10 - (6.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Welder,      10 - (7.5 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.CatPack,     10 - (9.0 + random )))
-- fast sprint
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.PhaseTech, 		10 - (4.5 + random )))
-- fast reload
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.AdvancedWeaponry,	10 - (3.5 + random )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Shotgun,     10 - (1.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Flamethrower,     10 - (1.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.HeavyMachineGun,     10 - (1.0 + random )))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.GrenadeLauncher,     10 - (1.0 + random2 )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Jetpack, 10 - (1.25 + random )))

table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.DualMinigunExosuit, 5.0 + random ))
table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.DualRailgunExosuit, 5.0 + random2 ))

if kShieldGeneratorCost then
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.ShieldGenerator, 10 - (1.0 + random2 )))
end
if kCannonCost then
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Cannon, 10 - (0.8 + random2 )))
end
if kSubmachinegunCost then
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Submachinegun, 10 - (1.4 + random2 )))
end