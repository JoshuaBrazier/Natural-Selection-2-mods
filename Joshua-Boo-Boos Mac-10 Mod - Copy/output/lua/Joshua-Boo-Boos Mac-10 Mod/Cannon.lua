...
--local kAttackSoundName = PrecacheAsset("sound/combat/combat.fev/combat/weapons/marine/heavy_cannon/fire")
--local kLocalAttackSoundName = PrecacheAsset("sound/combat/combat.fev/combat/weapons/marine/heavy_cannon/fire_client")
