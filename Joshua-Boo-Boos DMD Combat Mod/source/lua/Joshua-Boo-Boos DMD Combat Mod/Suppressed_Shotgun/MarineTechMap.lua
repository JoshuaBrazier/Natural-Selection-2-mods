table.insert(kMarineTechMap, { kTechId.SuppressedShotgunTech, 4.5, 5.5 })
table.insert(kMarineLines, GetLinePositionForTechMap(kMarineTechMap, kTechId.Armory, kTechId.SuppressedShotgunTech))
