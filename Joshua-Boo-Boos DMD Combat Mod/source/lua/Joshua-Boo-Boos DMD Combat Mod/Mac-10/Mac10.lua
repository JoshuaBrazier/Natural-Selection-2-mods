...
Mac10.kModelName = PrecacheAsset("models/Mac-10/Mac-10_World.model")
...
local reload_sound = PrecacheAsset("sound/Mac-10/Mac10.fev/Mac10_Sounds/Reload")
local shoot_sound = PrecacheAsset("sound/Mac-10/Mac10.fev/Mac10_Sounds/Shoot")
