...
local standard_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/standard")
local buckshot_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/buckshot")
local incendiary_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/incendiary")
local slug_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/slug")
local reload_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/reload")

-- local danger_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/danger")
-- local enemy_nearby_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/enemy_nearby")
-- local enemy_detected_sound = PrecacheAsset("sound/Shotgun/shotgun_sounds.fev/shotgun sounds/enemy_detected")
