...
if not kCombatVersion then
    ...
    GUIMarineBuyMenu.kButtonGroupFrame_Labeled_x1     = PrecacheAsset("ui/Suppressed_Shotgun/buymenu_marine/button_group_frame_labeled_x1.dds")
    ...
    local kSuppressedShotgunNewButtonImage = PrecacheAsset("ui/Suppressed_Shotgun/buymenu_marine/SuppressedShotgun_button.dds")
    local kSuppressedShotgunNewBigInfoImage = PrecacheAsset("ui/Suppressed_Shotgun/buymenu_marine/SuppressedShotgun_bigicon.dds")
    ...
    local SuppressedShotgunTexture = PrecacheAsset("ui/Suppressed_Shotgun/buymenu_marine/SuppressedShotguncombaticon.dds")
